...
- Use hull_data['x'] and hull_data['y'] directly — participant hulls are ALREADY closed in convex_hulls.pkl (first point == last point). Do NOT append the first point again (that would create duplicate vertices).
